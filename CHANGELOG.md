...
- address autocomplete will populate sublocality with sublocality, sublocality_level_1, etc. depending on what is available; utm parameters preserved when /run endpoint used ([a243212](https://github.com/dblevin1/docassemble/commit/a243212d1a3bd71bdbc3d27cb61f7c9f9f40166f) by Jonathan Pyle).
- added age_in_months; added default gitignore; allow docx transformations when using _use_jinja2=False in include_docx_template; allow get_user_info() when user is anonymous but has permission; clean up the data representation of questions; upgrade boto3; consistent dating of store_variables_snapshot entries; avoid problem with interview-specific settings being called outside interview context ([e881f90](https://github.com/dblevin1/docassemble/commit/e881f90a3a0b0e5611def33d0f7bf14e7918d277) by Jonathan Pyle).

### Fixed

- fix publish script ([075f549](https://github.com/dblevin1/docassemble/commit/075f5490f7919197e286aac64af9b7eadf98942f) by Daniel Blevins).
- fixed issue where objects block created false attribute when an index followed the attribute ([5a3eb39](https://github.com/dblevin1/docassemble/commit/5a3eb393afbacb80a294cafe0804c0a8e2b9ec66) by Jonathan Pyle).
- fix bug in DAList initializeObject ([0264776](https://github.com/dblevin1/docassemble/commit/02647762a305b82a0a555d44cfe57ceeddbe6ac5) by Jonathan Pyle).
- fix issue with object_checkboxes and object_multiselect being used as elements in a list or dict; upgrade pikepdf ([3a8a42d](https://github.com/dblevin1/docassemble/commit/3a8a42d2aeca3d25c3ac77f476866d00a9fdaaee) by Jonathan Pyle).
- fix DOCX files generated by docxtpl so that they do not contain any duplicate files ([f6b18a1](https://github.com/dblevin1/docassemble/commit/f6b18a16cc11f8655111b325b3354da064211326) by Jonathan Pyle).

### Changed

- change docker compose to use github image ([af7a801](https://github.com/dblevin1/docassemble/commit/af7a8010d11062456c9944602c97dde0c8021bd9) by Daniel Blevins).

### Merged

- Merge branch 'upstream-latest' ([381a96a](https://github.com/dblevin1/docassemble/commit/381a96a86f5b0771a93e686c7018c612762e3dd0) by Daniel Blevins).
- Merge branch 'master' of github.com:jhpyle/docassemble ([5852af5](https://github.com/dblevin1/docassemble/commit/5852af597586d606ff21d306fe34be696a71823e) by Jonathan Pyle).
- Merge pull request #796 from jhpyle/dependabot/pip/docassemble_base/cryptography-43.0.1 ([b95eba6](https://github.com/dblevin1/docassemble/commit/b95eba6121e012ea3400823f37567b305222b79e) by Jonathan Pyle).
- Merge pull request #795 from jhpyle/dependabot/pip/docassemble_webapp/flask-cors-5.0.0 ([a309984](https://github.com/dblevin1/docassemble/commit/a309984a909d8e6a6fd3f0b2b26b5e848fee7aaf) by Jonathan Pyle).
- Merge pull request #794 from nonprofittechy/filter-html-in-meta-tags ([55e4c53](https://github.com/dblevin1/docassemble/commit/55e4c53ebf263735ec0d8d42b32aeaec645a6e1a) by Jonathan Pyle).
- Merge pull request #787 from jhpyle/dependabot/pip/docassemble_base/urllib3-2.2.2 ([5fd14bf](https://github.com/dblevin1/docassemble/commit/5fd14bfa2b805fd938e28e4ac86f4faba5a5fa61) by Jonathan Pyle).
- Merge pull request #788 from jhpyle/dependabot/pip/docassemble_base/zipp-3.19.1 ([cc7305f](https://github.com/dblevin1/docassemble/commit/cc7305f84e887e9d6b5463f00da469a5c4c2b9c3) by Jonathan Pyle).
- Merge pull request #789 from jhpyle/dependabot/pip/docassemble_base/certifi-2024.7.4 ([5cf03fa](https://github.com/dblevin1/docassemble/commit/5cf03fac7d46dcaac99746220da8164d340519da) by Jonathan Pyle).
- Merge pull request #779 from jhpyle/dependabot/pip/docassemble_webapp/azure-identity-1.16.1 ([6e3db29](https://github.com/dblevin1/docassemble/commit/6e3db29d2636101ead45025ebcbeb51eeacc312b) by Jonathan Pyle).
- Merge pull request #780 from jhpyle/dependabot/pip/docassemble_webapp/msal-1.28.0 ([1c1c3d5](https://github.com/dblevin1/docassemble/commit/1c1c3d5448a1d1524681c61e3686673bfe5eea28) by Jonathan Pyle).
- Merge pull request #781 from jhpyle/dependabot/pip/docassemble_webapp/urllib3-2.2.2 ([8c06d42](https://github.com/dblevin1/docassemble/commit/8c06d42697be0912a36acdc5240757f64a5c0839) by Jonathan Pyle).
- Merge pull request #782 from jhpyle/dependabot/pip/docassemble_webapp/scikit-learn-1.5.0 ([0f3e07e](https://github.com/dblevin1/docassemble/commit/0f3e07e36f05b5a39acd28e2ae751b29328a79a6) by Jonathan Pyle).
- Merge pull request #783 from jhpyle/dependabot/pip/docassemble_webapp/certifi-2024.7.4 ([31d9cfd](https://github.com/dblevin1/docassemble/commit/31d9cfda83a34587f3d1658e6a258e6ea1361915) by Jonathan Pyle).
- Merge pull request #786 from jhpyle/dependabot/pip/docassemble_webapp/zipp-3.19.1 ([c21c282](https://github.com/dblevin1/docassemble/commit/c21c2826b0fbf87f6fce614899cf92471ca9f4b5) by Jonathan Pyle).
...
- added metadata feature to attachment options block; include .gitignore in packages generated by the Playground; prevent API requests from restoring sessions or returning session cookies ([47f0eac](https://github.com/dblevin1/docassemble/commit/47f0eac5cfa9e9acf1edf9947b03d75e581d5f2a) by Jonathan Pyle).
- added radiogroup role to the fieldset and moved the aria-required to the fieldset ([ddab7d4](https://github.com/dblevin1/docassemble/commit/ddab7d4d2ff1cf95880d5bf9ad401a12be286f3a) by Jonathan Pyle).
- added attachment object to current_context() for getting information about the attachment currently being assembled; fix mistakes in code for some recipe examples; added project switcher to UI of Word sidebar; avoid PostgreSQL error when uninstalling a package in a multiserver environment ([8554f74](https://github.com/dblevin1/docassemble/commit/8554f74e274656337ccdc033cff4c480747d491e) by Jonathan Pyle).

### Fixed

- fix nonetype error on restart_session ([5c8960a](https://github.com/dblevin1/docassemble/commit/5c8960a712a9861c89ce99ed6b3b000b5385a4e7) by Daniel Blevins).

### Removed

- removed aria-required from elements that are not input elements; upgraded Bootstrap, jQuery, and Font Awesome; fixed bug with progress bar multiplier; allowed objects from file to run as a mandatory block; changed code that resulted in checkin processing to remove the active action; fixed CSS problem with radio buttons and labels above fields ([512bacc](https://github.com/dblevin1/docassemble/commit/512bacce7f492b3e7d634898e27a68f83ac2e819) by Jonathan Pyle).

### Merged

- Merge branch 'upstream-latest' ([02c385c](https://github.com/dblevin1/docassemble/commit/02c385c22441ef1602948eaa20296a1aacb88f97) by Daniel Blevins).
- Merged requests upgrade ([3564574](https://github.com/dblevin1/docassemble/commit/3564574a2338937a83caf018aa91e2784dc79a20) by Jonathan Pyle).
- Merge pull request #778 from jhpyle/dependabot/pip/docassemble_base/requests-2.32.2 ([17401e3](https://github.com/dblevin1/docassemble/commit/17401e3ea84158b45ed50fb755b9bfa654265926) by Jonathan Pyle).
- Merge pull request #777 from jhpyle/dependabot/pip/docassemble_webapp/flask-cors-4.0.1 ([f70272f](https://github.com/dblevin1/docassemble/commit/f70272fe03852f9b5a483ede44a7de3f44540d12) by Jonathan Pyle).
- Merge pull request #776 from jhpyle/dependabot/pip/docassemble_webapp/requests-2.32.0 ([9141ed2](https://github.com/dblevin1/docassemble/commit/9141ed2ff4c1216f3e082685c40df54d5a91f392) by Jonathan Pyle).
- Merge branch 'master' of github.com:jhpyle/docassemble ([0d23d89](https://github.com/dblevin1/docassemble/commit/0d23d8956759144109d2863ba56602dc1cc5e43b) by Jonathan Pyle).
- Merge pull request #775 from jhpyle/dependabot/pip/docassemble_webapp/jinja2-3.1.4 ([cb1be5d](https://github.com/dblevin1/docassemble/commit/cb1be5d1a45514713b014aaebc0e424f2e4715a4) by Jonathan Pyle).
- Merge pull request #774 from jhpyle/dependabot/pip/docassemble_base/jinja2-3.1.4 ([faefbda](https://github.com/dblevin1/docassemble/commit/faefbda4aa432b7ed794dd8282eb89cd316e47b0) by Jonathan Pyle).
- Merge pull request #773 from jhpyle/dependabot/pip/docassemble_webapp/werkzeug-3.0.3 ([1d9d899](https://github.com/dblevin1/docassemble/commit/1d9d89986c90d89b9f7e7061689a5a9b1a9b0594) by Jonathan Pyle).
- Merge pull request #772 from jhpyle/dependabot/pip/docassemble_base/werkzeug-3.0.3 ([6954eea](https://github.com/dblevin1/docassemble/commit/6954eea7f97676a5d51d5d99701ac52d6c759919) by Jonathan Pyle).
- Merge pull request #769 from jhpyle/dependabot/pip/docassemble_base/tqdm-4.66.3 ([a4fe98d](https://github.com/dblevin1/docassemble/commit/a4fe98dd5fe902b52b34ca3ac4b81a902561c01d) by Jonathan Pyle).
- Merge pull request #768 from jhpyle/dependabot/pip/docassemble_webapp/tqdm-4.66.3 ([ee5c5e8](https://github.com/dblevin1/docassemble/commit/ee5c5e8a91610718758cc15c7b6c93a8abeb76f6) by Jonathan Pyle).
- Merge pull request #754 from BryceStevenWilley/login_link_style_consistent ([3a8a798](https://github.com/dblevin1/docassemble/commit/3a8a798d616eacf170b03efd5a704c7f05e6f3cf) by Jonathan Pyle).
- Merge pull request #757 from jhpyle/dependabot/pip/docassemble_webapp/pillow-10.3.0 ([f14f56a](https://github.com/dblevin1/docassemble/commit/f14f56a2931e0b2d0aa40663525c3f9b61bd213f) by Jonathan Pyle).
- Merge pull request #758 from jhpyle/dependabot/pip/docassemble_base/pillow-10.3.0 ([b55e431](https://github.com/dblevin1/docassemble/commit/b55e4312dbc0e381e4d8cd86b8472dc6a9ab45a1) by Jonathan Pyle).
- Merge pull request #759 from jhpyle/dependabot/pip/docassemble_webapp/idna-3.7 ([c7e7ed9](https://github.com/dblevin1/docassemble/commit/c7e7ed92973c148105855a85dffe7a25ae61aa2f) by Jonathan Pyle).
- Merge pull request #760 from jhpyle/dependabot/pip/docassemble_base/idna-3.7 ([41d7a49](https://github.com/dblevin1/docassemble/commit/41d7a49b8adc2736430754b550d7ed4ba034c9a7) by Jonathan Pyle).
- Merge pull request #761 from jhpyle/dependabot/pip/docassemble_webapp/eventlet-0.35.2 ([39e34a1](https://github.com/dblevin1/docassemble/commit/39e34a180a1fe3c5d0b40a952e89bb11844cd149) by Jonathan Pyle).
- Merge pull request #762 from jhpyle/dependabot/pip/docassemble_webapp/dnspython-2.6.1 ([3db0f92](https://github.com/dblevin1/docassemble/commit/3db0f9279ae1571f612fbbc1aa06a1dab44c6340) by Jonathan Pyle).
- Merge pull request #764 from jhpyle/dependabot/pip/docassemble_base/aiohttp-3.9.4 ([b2d9f12](https://github.com/dblevin1/docassemble/commit/b2d9f12e898417a424d4e0119245639f80d59768) by Jonathan Pyle).
- Merge pull request #765 from jhpyle/dependabot/pip/docassemble_webapp/aiohttp-3.9.4 ([d6e28c5](https://github.com/dblevin1/docassemble/commit/d6e28c577cbf9d4afc4a98dce9fa2b38023aa621) by Jonathan Pyle).
